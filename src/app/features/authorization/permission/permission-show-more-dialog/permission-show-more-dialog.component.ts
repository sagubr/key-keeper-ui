...
@Component({
	...
	templateUrl: './permission-show-more-dialog.component.html',
	styleUrl: './permission-show-more-dialog.component.scss'
})
export class PermissionShowMoreDialogComponent implements OnInit, AfterViewInit {
	...
	columns: Columns<string>[] = [
		{
			...
			cell: (permission: string) => permission
		},
	];
	...
	constructor(
		public dialogRef: MatDialogRef<PermissionShowMoreDialogComponent>,
