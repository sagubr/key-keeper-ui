...
} from '@app/features/resource-management/user-management/user-management-dialog-password-form/user-management-dialog-password-form.component';
...
} from "@app/features/resource-management/user-management/user-management-dialog-form/user-management-dialog-form.component";
